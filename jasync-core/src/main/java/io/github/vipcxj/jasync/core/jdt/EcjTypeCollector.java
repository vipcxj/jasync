    ...
    private static Map<String, String> getOptions(Object project) {
        try {
            ...
            try {
                ...
                Class<?> aptConfigClass = ClassLoaderHelper.loadClass("io.github.vipcxj.jasync.core.jdt.AptConfig", projectClass);
...
//        }
        try {
            ...
            Class<?> fileManagerClass = ClassLoaderHelper.loadClass("io.github.vipcxj.jasync.core.jdt.EclipseFileManager", project.getClass());
