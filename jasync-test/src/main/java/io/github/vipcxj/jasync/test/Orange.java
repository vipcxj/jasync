...
public class Orange {
    ...
    @Async
    public JPromise<Void> testSimple() {
        String message = "say";
    ...
    public <T> T test(int a, String b, T c) {
        ...
        new PromiseFunction<Integer, Void>() {
            @Override
            public JPromise<Void> apply(Integer integer) throws Throwable {
